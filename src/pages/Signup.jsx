        ...
        <div className="relative bg-black/40 border border-white/10 rounded-2xl p-5 md:p-6 backdrop-blur-2xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              ...
              <p className="text-gray-500 text-[11px] font-medium">Join our community today</p>
            </div>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleSubmit(handleSignup)} className="space-y-3.5">
            {/* Name Field */}
            <div className="space-y-1 group">
              ...
              <div className="relative">
                <div
                  className={`absolute inset-0 bg-violet-500/10 rounded-xl blur-md transition-opacity duration-300 ${focused === "name" ? "opacity-100" : "opacity-0"}`}
                />
                <div
              ...
              {errors.name && (
                <p className="text-[10px] text-red-400 ml-1 font-semibold">{errors.name.message}</p>
              )}
            </div>
